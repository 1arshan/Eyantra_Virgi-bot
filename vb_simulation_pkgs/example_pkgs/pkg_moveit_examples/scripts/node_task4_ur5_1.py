...
def handle_bot1():
    ...
    [
        define_joint_angle_list(-55,-97,88,7,125,4),
    ...
    [
        ...
        define_joint_angle_list(-117,-118,134,-17,66,1),
    ...
    for i in range(0,4):
        for z in range(0,3):
            if (i == 3 and z == 2) or (i == 2 and z==1) or (i==2 and z == 2):
                continue

            print(i,z,': index')
           
            resp1 =  ur5.hard_set_joint_angles(coordinate_matrix[i][z],4)
            if(not resp1):
                continue
            ...
            resp2 = ur5.hard_set_joint_angles(define_joint_angle_list(179,-57,86,-119,-88,-90),4)
...
def main():
    rospy.init_node('node_task4_ur5_1', anonymous=True)
    handle_bot1()
    rospy.spin()
