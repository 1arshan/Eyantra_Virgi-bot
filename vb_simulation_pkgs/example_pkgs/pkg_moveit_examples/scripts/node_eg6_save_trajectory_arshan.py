...
def handle_bot1():
    ...
    for i in range(0,2):
        #rospy.sleep(1)
        if i==0:
            ur5.add_box(pose_x[1],pose_y,pose_z[0])
            ur5.hard_set_joint_angles(lst_joint_angles_01,4)
            
        elif i==1:
            ur5.add_box(pose_x[1],pose_y,pose_z[1])
        ...
        # ur5.hard_set_joint_angles(define_joint_angle_list(3,-135,-44,-90,83,-102),4)
        ur5.hard_set_joint_angles(define_joint_angle_list(0,-120,-85,-65,90,100),4)
