...
def handle_bot1():
    ...
    for i in range(0,4):
        for z in range(0,3):
            print(i,z,': index\n')
            ur5.change_file_path('package'+str(i)+str(z)+'/')
           
            ur5.hard_set_joint_angles(coordinate_matrix[i][z],10)
            ...
            ur5.hard_set_joint_angles(define_joint_angle_list(4,-153,-30,-88,78,0),10)
